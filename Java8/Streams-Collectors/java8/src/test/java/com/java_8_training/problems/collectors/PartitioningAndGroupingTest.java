...
public class PartitioningAndGroupingTest {
    ...
    public void groupDishes() {
        ...
        //TODO #C2
//
        groupedDishes = Dish.menu.stream().collect(groupingBy(Dish::getTypeByCalories));
    ...
    public void groupCounting(){
        ...
        groupedDishes = Dish.menu.stream().filter(d -> d.getCalories() > 140).collect(groupingBy(Dish::getType, counting()));
